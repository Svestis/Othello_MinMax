...
Για κάθε μια από τις τρείς συναρτήσεις εκτελέσαμε τυχαιοποιημένα πειράματα (220 εκτελέσεις για διάφορα βάθη ανά συνάρτηση) για να αποφασίσουμε για το βέλτιστο.
...
![PCP](mdReportData/evaluationfunction.png)
