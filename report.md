...
<img src="mdReportData/pyc.png" width="750">

###### Παραμετροποίηση cmd

<img src="mdReportData/pycm.png" width="700">
...
μέθοδος που χρησιμοποιείτε άμεσα από το minimax.  
  ...
  δυο αποφασίζει και προσθέτει 1000 πόντους στον νικητή.  
...
Εν συνεχεία εστιάσαμε στην βελτίωση του evaluation function. Επικεντρωθήκαμε σε 3 συναρτήσεις:
1. +1 για κάθε πούλι του υπολογιστή, -1 για κάθε πούλι που παίκτη, +/- 100 για νίκη του υπολογιστή ή του παίκτη αντίστοιχα
2. +1 για κάθε πούλι του υπολογιστή, -1 για κάθε πούλι του παίκτη. Σε περιπτώση γωνιακών θέσεων, αυτές αξιολογούνται με +/- 5 για πούλι του υπολογιστή ή του παίκτη αντίστοιχα και +/- 3 για τον υπολογιστή ή τον παίκτη αντίστοιχα, για τις θέσεις στην οριογραμμή του board (πλήν των γωνιακών θέσεων). Τέλος +/- 1000 για νίκη του υπολογιστή ή του παίκτη αντίστοιχα
3. +1 για κάθε πούλι του υπολογιστή, -1 για κάθε πούλι του παίκτη. Το σκορ προσαρμόζεται για τις γειτονικές στις γωνιακές θέσεις. Οι γωνιακές θέσεις αξιολογούνται με +/- 25 για κάθε πούλι του υπολογιστή ή του παίκτη αντίστοιχα και οι θέσεις στην οριογραμμή του board (πλην των γωνιακών θέσεων και των θέσεων που αποτελούν γειτονικές στα γωνιακά σημεία) αξιολογούνται με +/- 5 για κάθε πούλι του υπολογιστή ή του παίκτη αντίστοιχα.

Για κάθε μια από τις τρείς συναρτήσεις εκτελέσαμε τυχαιοποιημένα πειράματα (220 εκτελέσεις για διάφορα βάθη ανά συνάρτηση) για να αποφασίσουμε για τη βέλτιστη.

Παρακάτω ακολουθεί μια σύνοψη των αποτελεσμάτων, που εξηγούν και σαφώς τον λόγω που καταλήξαμε στην χρήση της 3ης συνάρτηση όπως περιγράφηκε παραπάνω.
Το πλήρες υπολογιστικό φύλλο είναι διαθέσιμο και στην υποβολή.

<img src="mdReportData/evaluationfunction.png" width="680">

Τέλος, σαν ιδέα είχαμε την χρήση κάποιας συνάρτηση που μετράει τις εναπομείναντες κινήσεις ή/και συνδυασμό διαφόρων συναρτήσεων ανάλογα με το στάδιο του παιχνιδιού (early game, end game κλπ) όμως λόγω χρόνου (ιδιαίτερα χρονοβόρα ήταν τα τυχαιοποιημένα πειράματα) δεν καταφέραμε να το εφαρμόσουμε.
